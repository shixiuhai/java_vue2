	...
	<div>
		...
		<el-table
			...
			<el-table-column
				...
				<template slot-scope="scope">
					<el-tag size="small" v-if="scope.row.statu === 1" type="success">借款期中</el-tag>
					<el-tag size="small" v-else-if="scope.row.statu === 0" type="danger">借款逾期</el-tag>
				</template>
		...
		<el-dialog
			...
			<el-form :model="editForm" :rules="editFormRules" ref="editForm" label-width="100px" class="demo-editForm">
				...
				<el-form-item label="借款人" prop="brrowerName" label-width="100px">
				...
				<el-form-item label="状态" prop="statu" label-width="100px">
					<el-radio-group v-model="editForm.statu">
						<el-radio :label=0>借款期中</el-radio>
						<el-radio :label=1>借款逾期</el-radio>
					</el-radio-group>
				</el-form-item>
